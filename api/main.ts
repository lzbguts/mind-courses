...
async function execDB() {
    ...
    await aaSqlite.push("CREATE TABLE IF NOT EXISTS Cursos( id INTEGER PRIMARY KEY, idUsuario INTEGER NOT NULL, nome TEXT NOT NULL, professor TEXT NOT NULL, categoria TEXT NOT NULL, descricao TEXT NOT NULL, imagem TEXT NOT NULL, FOREIGN KEY (idUsuario) REFERENCES Users (id) ON DELETE CASCADE ON UPDATE NO ACTION);");
}
execDB();
